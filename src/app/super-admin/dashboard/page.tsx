...
const timeline = [
  {
    ...
    events: [
      {
        id: 1,
        title: "Speech by General Chair Representation",
        time: "1h 40m",
        speaker: "Mahananta",
        room: "Room A",
  ...
  },
  {
    ...
    events: [
      {
        id: 3,
        title: "Keynote Speaker 1: The Future of AI in Research",
        time: "1h 30m",
...
export default function DashboardPage() {
  ...
  return (
    <>
      ...
      <p className="text-gray-600 font-poppins text-base lg:text-xl mb-6 lg:mb-8">
        to Dashboard
      </p>
